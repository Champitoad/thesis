...
\begin{proof}
  ...
  \end{array}
  $$
  We prove (\ref{app:eqn:weakdistrib-one}) by recurrence on $\sdepth{\J}$.
  \begin{itemize}
    \item[\bcase]
    $$
    \begin{array}{rcll}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \psint{\Gamma, (\piq{S}) \J \Delta}$ by recurrence on $\sdepth{\J}$.
    \begin{itemize}
      \item[\bcase]
        $$
        \begin{array}{rcll}
    ...
    \top \J \Delta}$ by recurrence on $\sdepth{\J}$.
    \begin{itemize}
      \item[\bcase]
      $$
      \begin{array}{rcll}
    ...
    \land B \J \Delta}$ by recurrence on $\sdepth{\J}$.
    \begin{itemize}
      \item[\bcase]
      $$
      \begin{array}{rcll}
    ...
    \psint{\Gamma \J A \limp B, \Delta}$ by recurrence on $\sdepth{\J}$.
    \begin{itemize}
      \item[\bcase]
      $$
      \begin{array}{rcll}
