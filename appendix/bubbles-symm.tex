...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item[{\rnmsf{f{-}{+}{\ua}}}, {\rnmsf{f{+}{-}{\ua}}}] Converse of
    {\rnmsf{f{-}{+}{\da}}} (resp. {\rnmsf{f{+}{-}{\da}}}), using
    the converse inequality of \reffact{weakdistrib} which only holds in
    Boolean algebras.

    \item[{\rnmsf{f{+}{+}{\da}}}, {\rnmsf{f{-}{-}{\da}}}] Converse
    of {\rnmsf{f{+}{+}{\ua}}} (resp. {\rnmsf{f{-}{-}{\ua}}}), using
...
\begin{lemma}[Simulation of \sys{DBiInt}]\lablemma{app:simulation-dbiint}
