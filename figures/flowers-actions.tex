...
\Action{Import} & \kl{DnD} of $\phi$ into $\Xi\hole$ & $$\prftree[l][r]{\rsf{poll{\ua}}}{$\phi$ non-atomic}{\Xi\select{\phi}}{\Xi\select{\phantom{\phi}}}$$ \\ \hline
...
\Action{Grow} & \texttt{Add} button in \kl{positive} bouquet & $$\R[\rsf{grow}]{\Xi^+\select{\flower{}{\garden{}{}}}}{\Xi^+\select{\phantom{\flower{}{\garden{}{}}}}}$$ \\ \hline
\Action{Glue} & \texttt{Add} button in \kl{negative} corolla & $$\R[\rsf{glue}]{\Xi^-\select{\flower{\gamma}{\garden{}{} \sep \Delta}}}{\Xi^-\select{\flower{\gamma}{\Delta}}}$$ \\ \hline
...
\Action{Crop} & Click on \kl{negative} flower & $$\R[\rsf{crop}]{\Xi^-\select{\phantom{\phi}}}{\Xi^-\select{\phi}}$$ \\ \hline
\Action{Pull} & Click on \kl{positive} petal & $$\R[\rsf{pull}]{\Xi^+\select{\flower{\gamma}{\Delta}}}{\Xi^+\select{\flower{\gamma}{\delta \sep \Delta}}}$$ \\ \hline
\end{tabular}
}
