...
\newcommand{\PhDTitle}{Deep Inference for \\ Graphical Theorem Proving} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{Pablo Donato} 															%% Civilité, nom et prénom /  Civility, first name and name 
\newcommand{\NNT}{2024IPPAX015} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\newcommand{\PhDspeciality}{Informatique, Données et Intelligence Artificielle}				%% Spécialité de doctorat / Speciality 
...
\newcommand{\defensedate}{29 mai 2024} 														%% Date de soutenance / Date of defense
...
\newcommand{\juryadressB}{Professeur, Université de Strasbourg (ICube)}
...
\newcommand{\juryadressI}{Chercheur, Inria (Sophia Antipolis)}
...
\newcommand{\juryadressF}{Chargé de recherche, PQShield}
...
\begin{textblock}{1}(\hpostt,\vpostt)
	...
	% \includegraphics[scale=1]{media/etab/} 
\end{textblock}

\begin{textblock}{1}(\hpos,\vpos)
	\textblockcolour{white}
	\includegraphics[scale=1]{media/etab/X.png}
\end{textblock}
