...
We finally go back to practical experimentation with the Flower Prover, another
web-based prototype of GUI based on the flower calculus, which has the property
of working well on modern mobile devices equipped with touchscreens of varying
sizes.
