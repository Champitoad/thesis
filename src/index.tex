...
While the paradigm proposed in this first part of the thesis is confined to
direct manipulation of \emph{formulas} inside a goal/sequent, we will explore in
the second part of the thesis how to design pointing-based interactions for
manipulating the \emph{goals themselves}. The idea of \emph{proof-by-action}
then applies equally at both levels of formulas and goals, as a general
principle of proof state manipulation by gestural actions.


\input{chapters/pba.tex}

% \input{chapters/pbl.tex}

% \input{chapters/beyond}

\pagelayout{wide} % No margins
\addpart{Manipulating goals}
\pagelayout{margin} % Restore margins
...
% \input{chapters/curryhoward.tex}
...
\vspace{2em}
\begin{kaobox}[frametitle=TODO]
	Remove duplicate entries in bibliography.
\end{kaobox}
