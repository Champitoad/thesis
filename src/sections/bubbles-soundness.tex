...
%   $\bradepth{\piq{\cS}}$.
%   \begin{itemize}proof
%     \item[\textbf{Base case}] Suppose $\bradepth{\piq{\cS}} = 1$, and
...
%     \end{array}
%     $$
%     \item[\textbf{Recursive case}] Suppose $\bradepth{\piq{\cS}} > 1$.
...
\begin{proof}
  ...
  \reflemma{bubbles-local-soundness} by Corollary \ref{cor:lsoundness}.
\end{proof}
