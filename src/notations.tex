...
\newcommand{\psheet}[1]{\color{black}{#1}}
\newcommand{\nsheet}[1]{\color{white}\colorbox{black}{$#1$}}
\newcommand{\pcut}[1]{\color{white}\fillcircled{white}{\color{black}$#1$}}
\newcommand{\ncut}[1]{\color{black}\fillcircled{black}{\color{white}$#1$}}
\newcommand{\ppcut}[1]{\color{black}\circled{$#1$}}
\newcommand{\npcut}[1]{\color{black}\fillcircled{npcut}{$#1$}}
