...
\newcommand{\piq}[1]{~\langle #1 \rangle~}

\newcommand*\circled[1]{\tikz[baseline=(char.base)]{
            \node[shape=circle,draw,inner sep=2pt] (char) {#1};}}
\newcommand{\bubble}[3]{\circled{\hypo{#1} ~~ #2 ~~ \conc{#3}}}

\newcommand{\ainterp}[1]{\llbracket #1 \rrbracket^a}
\newcommand{\sinterp}[1]{\llbracket #1 \rrbracket^s}
