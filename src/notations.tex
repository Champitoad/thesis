...
\newcommand{\bbubble}[1]{\color{bubble}\greencircled{$#1$}}
\newcommand{\bsheet}[1]{\colorbox{solved}{#1}}

\newcommand{\ainterp}[1]{\llfloor #1 \rrfloor}
\newcommand{\sinterp}[1]{\llbracket #1 \rrbracket}
\newcommand{\psinterp}[1]{\llbracket #1 \rrbracket^+}
\newcommand{\nsinterp}[1]{\llbracket #1 \rrbracket^-}
...
\newcommand{\popping}{\textsc{$\mathbb{P}$opping}}
