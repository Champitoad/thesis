...
of) inference rules with premiss $T$ and conclusion $S$\sidenote[][-10cm]{The
...
the {\rnmsf{p}} rule could have been postponed to the top/end of the derivation.
...
these concerns will be tackled in \refsec{invertible-calculus}, but we think a
...
\todo{Add graphical version of \reffig{ex-seq-BJ}}

\section{Back to Proof-by-Action}

\todo{Describe precisely how rules can be mapped to graphical actions.}
