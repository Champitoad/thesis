...
an existing theorem prover as its backend) can be accessed online at
...
implementation design of Actema will be provided in \refch{plugin}.
...
work}. We will not explore the design of such features in this thesis, since we
...
reasoning\sidenote{For a related work that tackles this problem in the context
of functional programming, see \cite{omar-filling-2021}.}. Note however that it
