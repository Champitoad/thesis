...
involving logical connectives and quantifiers. \refsec{correctness} introduces
...
in the original formulation and implementation of \emph{subformula linking}
...
\begin{itemize}
  ...
  The incorrect proof structures of Girard are more general in this respect as
  they cannot always be mapped to correct sequent calculus derivations.}.
\end{itemize}
