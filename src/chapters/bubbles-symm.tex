...
$$
\sint{\Gamma \piq{\mathcal{S}} \Delta} =
\bigwedge \Gamma \limp \bigvee \Delta \land \bigwedge_{S \in \mathcal{S}}{\sint{S}}
$$
...
$\Gamma$ and subgoals $\mathcal{S}$, it trivializes it to $\sint{\Gamma
...
$$
\sint{\Gamma \piq{\mathcal{S}} \Delta} =
\bigwedge{\Gamma} \limp \bigwedge_{S \in \mathcal{S}}{\sint{S}} \lor \bigvee \Delta
$$
...
\begin{definition}[Symmetric interpretation]\labdef{sinterp}
  ...
  \begin{align*}
    \sint{\Gamma \piq{\mathcal{S}} \Delta} &=
      \bigwedge_{S \in \mathcal{S}} \sint{S \mix (\Gamma \seq \Delta)} \\
...
\begin{definition}[Polarized symmetric interpretation]\labdef{pol-sinterp}
  ...
  \begin{align*}
    ...
    \psint{\Gamma \piq{\mathcal{S}} \Delta} &=
      \bigwedge_{S \in \mathcal{S}} \psint{S \mix \Gamma \seq \Delta} &
    \nsint{\Gamma \piq{\mathcal{S}} \Delta} &=
      \bigvee_{S \in \mathcal{S}} \nsint{S \mix \Gamma \seq \Delta} \\
    \psint{\Gamma \seq \Delta} &=
      \bigwedge_{I \in \Gamma} \nsint{I} \limp \bigvee_{I \in \Delta} \psint{I} &
    \nsint{\Gamma \seq \Delta} &=
      \bigwedge_{I \in \Gamma} \nsint{I} \lsub \bigvee_{I \in \Delta} \psint{I}
  \end{align*}
\end{definition}
...
\begin{description}
  ...
  \item[Linearity] 
    ...
    already remarked by the authors of the Proof-by-Pointing paradigm
    \sidenote{Section 4.1 of \cite{PbP}.}, rules that systematically duplicate
    formulas can quickly overload the goal with useless copies, making it harder
...
\todo{ Talk about flow rules for moving outside bubbles motivated by the need of
