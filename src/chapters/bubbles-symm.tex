...
introduce a core \emph{symmetric bubble calculus} for classical logic called
``system \sys{B}''. In \refsec{bubbles-soundness} we prove the soundness of
system \sys{B}, showing along the way that by removing selectively among 4
inference rules that define the \emph{porosity} of polarized bubbles, one gets
intuitionistic, dual-intuitionistic and bi-intuitionistic as fragments. In
...
\begin{definition}[Polarized symmetric interpretation]\labdef{pol-sinterp}
  ...
  \begin{align*}
    ...
    \psinterp{\Gamma \seq \Delta} &=
      \bigwedge_{I \in \Gamma} \nsinterp{I} \limp \bigvee_{I \in \Delta} \psinterp{I} &
    \nsinterp{\Gamma \seq \Delta} &=
      \bigwedge_{I \in \Gamma} \nsinterp{I} \lsub \bigvee_{I \in \Delta} \psinterp{I}
  \end{align*}
\end{definition}
