...
We will now unroll in details a complete interaction in \texttt{coq-actema},
starting from the \process{User} call to the \texttt{actema} tactic, and ending
with the new subgoals being display in the \process{IDE}. 
