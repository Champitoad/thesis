...
thus can never induce a backtracking point. The {\rnm{\lor R}} rule is an
example of invertible rule, and in \sys{LK} it can replace the other,
non-invertible rules {\rnm{\lor R_1}} and {\rnm{\lor R_2}}.
