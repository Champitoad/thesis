...
\begin{description}
  \item[\textbf{Weakening}]
    ...
    also been generalized to arbitrary \kl{solutions}. Indeed in system $\sysB$ we
...
\begin{description}
  ...
  \item[\textbf{Application}] When there are no more pairs of dual atoms, or all
    ...
    manually a specific \kl{subsolution} in $\imps{S}$ to apply the \rsf{{\limp}{-}}
...
equivalent \kl{solutions}, which is really just the $\mathbb{H}$-rules of system
$\sysB$ (\reffig{graphical-B}) where the right-hand \kl{solution} is enclosed in a
