...
In \reffig{sequent-B-inv} we define the \intro{B_{inv}} calculus, which results
...
\begin{description}
  ...
  \item[\textbf{Flow}]
    ...
    \emph{\kl{contraction}} followed by the application of a $\mathbb{F}$-rule
...
formulas. For now we only conjecture completeness of \kl{B_{inv}}, since it not
...
rules in \kl{B_{inv}}, then we immediately get our desired result: \kl{B_{inv}}
