...
As for the asymmetric bubble calculus \kl{BJ}, the rules of our full symmetric
...
top-level solution --- Peirce called it the \emph{\kl{sheet of assertion}}, the drop
...
\begin{description}
  ...
  \rsf{f{+}{\da}} rule for distributing conclusions in subgoals, which
  ...
  \begin{remark}
    Since all items can freely go in and out of polarized bubbles in \kl{classical}
  ...
  \rsf{f{\ua}}, which allows to move neutral bubbles out of other neutral
