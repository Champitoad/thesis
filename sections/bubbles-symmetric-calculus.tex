...
\begin{description}
  ...
  of the \kl{$\mathbb{F}$-rules} for red \kl{items}.
  
  A second difference is that \kl{$\mathbb{I}$-rules} are not applicable in arbitrary
  \kl{subsolutions}, but only \emph{\kl{unsaturated}} ones. This will also be
  the case of some \kl{$\mathbb{M}$-rules} and \kl{$\mathbb{H}$-rules}. In the case of the
  ...
  the \kl{$\mathbb{I}$-rules} which apply only to a formula $A$, \kl{$\mathbb{R}$-rules}
  ...
  \kl{$\mathbb{F}$-rules} handle the distribution of conclusions in \kl{subgoals}.
  Together with their dual rules \kl{\top{+}}, \kl{\land{+}} and
  \kl{{\limp}{+}}, they constitute the \emph{\kl[saturated]{saturating}} \kl{$\mathbb{H}$-rules} of
  \kl{system~B}. All other \kl{$\mathbb{H}$-rules} work in arbitrary \kl{solutions} just
...
\begin{description}
  ...
  explosion in the number of possible \kl{$\mathbb{F}$-rules}. Indeed, the general
  ...
  and $b = 1$), thus we had a total of $6$ possible \kl{$\mathbb{F}$-rules}. It turns
  ...
  the mix ($b = 3$), we get up to a total of $18$ possible \kl{$\mathbb{F}$-rules} in
  ...
  corresponding \kl{$\mathbb{F}$-rules} of \reffig{graphical-B}.
  ...
  In their graphical representation, the \kl{bi-intuitionistic} \kl{$\mathbb{F}$-rules} of
  ...
  counterpart --- in the grammatical sense --- of \kl{$\mathbb{F}$-rules},
  ...
  In particular, they suggest the addition of a new \kl{$\mathbb{F}$-rule}
  ...
  More generally in \kl{bi-intuitionistic} logic, all \kl{$\mathbb{F}$-rules} can be
  ...
  tree.
  % More generally, all outwards \kl{flow rules} (whose name ends with $\ua$) can
  ...
  This is mainly useful when one wants to apply an outward \kl{$\mathbb{F}$-rule} to
  ...
  \kl{$\mathbb{M}$-rules} and $\mathbb{F}$-laws.
\end{description}