...
solutions with no neutral \kl{bubbles} can be distinguished visually from open
...
\begin{description}
  ...
  \item[\textbf{\resource}] 
  Here we still have \kl{weakening} and \kl{contraction} for negative items (hypotheses),
  ...
  Compared to \kl{BJ} where we only had neutral bubbles, the presence of
  polarized \kl{bubbles} in system $\sysB$ creates a mini-combinatorial explosion in
  ...
  inwards or outwards. With $i$ item types and $b$ \kl{bubble} types, this makes for
  a total of $i \times b \times 2$ possible rules. In \kl{BJ} items consisted
  only of polarized formulas and neutral \kl{bubbles} ($i = 3$ and $b = 1$), thus we
  ...
  $\sysB$. Now with positive and negative \kl{bubbles} added to the mix ($b = 3$), we
  ...
  \rsf{f{+}{-}{\da}} rules, which allow a polarized item to flow
  \emph{into} a \kl{bubble} of \emph{opposite} polarity. However to get
  \emph{cut-free} completeness, we will also need a sort of dual of these rules,
  \rsf{f{+}{+}{\ua}} and \rsf{f{-}{-}{\ua}}, which allow a polarized
  item to flow \emph{out} of a \kl{bubble} with the \emph{same} polarity. Thus in
  ...
  to the $4$ rules that define the porosity of polarized \kl{bubbles} (\rsf{f{-}{+}{\ua}}, \rsf{f{+}{-}{\ua}}, \rsf{f{-}{-}{\da}},
  ...
  \begin{remark}
    Since all items can freely go in and out of polarized \kl{bubbles} in \kl{classical}
    logic, the latter are useless. In fact, one could restrict the syntax of
    solutions to neutral \kl{bubbles} and only one polarity of formulas, say
  ...
  \begin{fact}[$\mathbb{F}$-laws]\labfact{bubbles-flaws}
    \sbr
    \begin{enumerate}
      \item Polarized \kl{bubbles} trap (resp. repel) items with a different (resp.
      identical) polarity.
      \item Neutral \kl{bubbles} trap (resp. repel) polarized (resp. neutral) items.
      \item Polarized \kl{bubbles} both trap and repel neutral bubbles.
    \end{enumerate}
  ...
  \rsf{f{\ua}}, which allows to move neutral \kl{bubbles} out of other neutral
  ...
  item $I$ out of its \kl{subgoal} $S$. In the case of outward rules (whose name ends
  ...
  These rules state that when a \kl{bubble} contains only a single neutral bubble,
  ...
  (\refsec{branching}) and positive \kl{bubbles} (\refsec{colors}), both the
