...
\knowledgenewrobustcmd\solddual[1]{#1^{\cmdkl{\dagger}\cmdkl{\dagger}}}
...
\knowledgenewrobustcmd\ctxt[1]{\cmdkl{\mathsf{ctxt}}(#1)}
...
\newrobustcmd\psymbs{\withkl{\kl[\psymbs]}{\cmdkl{\mathscr{P}}}}
\knowledge{\psymbs}{notion,scope=eg}
\knowledge{\psymbs}{notion,scope=flower}
\newrobustcmd\arity{\withkl{\kl[\arity]}{\cmdkl{\mathsf{ar}}}}
\knowledge{\arity}{notion,scope=eg}
\knowledge{\arity}{notion,scope=flower}
