...
\begin{itemize}
  ...
  \itemAP \intro{Rewrite linkages} link one side of an equality with a first-order
...
rewrite rules of \reffig{DISL}, although from the user's standpoint \kl{linkages}
...
To the rewrite rules of \reffig{DISL} and \reffig{DISL-U}, we add \emph{\kl{linkage}
