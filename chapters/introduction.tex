...
In \refch{sfl}, we ground the semantics of \kl{DnD} actions in \kl{deep inference} proof
...
linkage}, which filters out \emph{non-productive} \kl{DnD} actions by restricting
