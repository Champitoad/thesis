...
\begin{description}[labelsep=0pt]
  ...
  \intro{proof view} or \reintro{goal view}. This corresponds to the goals that the
  ...
  assumptions in $\Gamma$. \kl{Tactics} generally apply to one goal at a time, and
...
In fact, following the \kl{proofs-as-programs} correspondence, we also believe that
...
The idea was to synthesize complex \kl{tactics} from the simple act of
