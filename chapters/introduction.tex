...
\intro{Proof assistants} --- also called \emph{interactive theorem provers}
...
graphical notations in the Lean proof assistant\sidenote{For a similar approach
...
\cite{coq-actema}. All other chapters present completely original and personal
work.
\end{kaonote}
