...
sound with its firm grounding in \kl{deep inference} proof theory (\refch{sfl} and
...
typically checking the \emph{validity} of linkages during a \kl{DnD} action, which
...
\begin{itemize}
  ...
  For \kl{DnD} actions, we essentially filter out all linkages that do not match the
...
The most complex tactics are those implementing backward and forward \kl{DnD}
...
\begin{remark}
  ...
  allows to export subformula linking derivations built with \kl{Profint}'s GUI
...
more fundamental questions, that have been much debated both in proof theory and
