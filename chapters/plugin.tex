...
Coq's low-level API for manipulating kernel \kl{terms}.
...
that Actema can maintain its own, \kl{first-order} version of the proof state,
...
propositions. But Coq statements are objects of \kl{type} \texttt{Prop}, and thus
...
including Coq \kl{terms} instantiating quantifiers that were computed in Actema by
...
\emph{strings}, but in order to manipulate \kl{terms} interactively in Actema we also
