...
\begin{remark}
  ...
  techniques in his \sys{Profint} tool \cite{DBLP:conf/cade/Chaudhuri21}, that
  allows to export subformula linking derivations built with \sys{Profint}'s GUI
