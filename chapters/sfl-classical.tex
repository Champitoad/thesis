...
related to the $\parr$ connective of linear logic which uses the {\kl{\lor R}}
rule of \reffig{multintro}, and whose spelling ``par'' is historically motivated
by an understanding of the multiplicative fragment of \kl{LL} as a logic of
parallel computation \cite{girard-linear-1987}.}. Hence we chose to call this
...
\kl{interaction operator} $\para$, which is suggestive of the parallel
