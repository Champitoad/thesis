...
goals, adjust the \kl{action} steps.}{\textbf{Confucius}}
...
In general, the \kl{action} solves the \kl{goal} when the interaction ends with the
trivially true proposition $\top$. The base case being the \kl{action} corresponding
