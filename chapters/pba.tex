...
\kl(dnd){backward} steps\sidenote{When viewed as \kl{types} through the Curry-Howard
...
interface} for the Coq \kl{proof assistant}. Another contemporary line of work was the
