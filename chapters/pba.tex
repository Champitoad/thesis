...
domain-specific interfaces for particular types of mathematical reasoning. The
latter has been tackled extensively in Ayers thesis \cite{ayers_thesis}, and
more specifically in his framework ProofWidgets for user-extensible graphical
notations in Lean\sidenote{For another related work that tackles this problem in
the context of functional programming, see \cite{omar-filling-2021}.}
\cite{ayers_thesis}. Note however that it is a necessary feature if one wants to
achieve a fully graphical theorem proving environment which is accessible to
non-expert users.
...
\section{Related works}\labsec{pbao-rw}
