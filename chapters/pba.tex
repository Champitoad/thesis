...
\begin{itemize}
  ...
  \refsec{newitems}); then she can drag the corresponding green \kl{item} and
  drop it on the quantified \kl{item} to instantiate it. It is also possible to
  select with the mouse an arbitrary subexpression occurring in any \kl{item} of
  the current \kl{goal}, and then drag-and-drop the \kl{item} holding the
