...
\refsec{multisets}. In \refsec{Calculus}, we introduce the full set of inference
...
go from a forward proof to a backward one as shown by the \emph{deduction
...
the flow of information in \kl{EGs}, and \reffig{bubbles-porosity} in bubbles. From a
...
destination of the \kl{DnD}).}. We distinguish two cases of \emph{cross}-pollination
and \emph{self}-pollination, as botanists do when describing the reproduction of
flowers. This distinction does not exist in \kl{classical} \kl{EGs}, because pistils and
petals are both identified as instances of \kl{cuts}\sidenote{The same phenomenon is
