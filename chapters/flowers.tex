...
rewriting system on flowers containing only atomic predicates. We also propose a
...
\begin{description}
  ...
  \item[Disjunction/Falsity Elimination (\rsf{srep})]
    ...
    disjunction in \kl{sequent calculus}, the $0$-ary case capturing falsity
    elimination (\textit{ex falso quodlibet}). The binary case is also used in
    the \kl{IEGs} system of \cite{minghui_graphical_2019}, together with its converse.
    ...
    and the Agda \kl{proof assistant} \sidecite{yuan-live-2023}.
\end{description}
...
of \emph{modus ponens} \kl{mp}, in \kl{sequent calculi} the \kl(rule){cut} rule, and
