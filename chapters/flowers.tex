...
to our Kripke semantics for flowers. We start with the pervasive
...
starting with the \emph{local} version of natural rules:
...
Thus we can conclude this section with our main soundness theorem, stating that
every derivation in the flower calculus is sound:

\begin{theorem}[Soundness]\label{cor:flowers-soundness}
