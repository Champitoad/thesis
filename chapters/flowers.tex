...
\cite[p.~79]{Lewis1920-LEWASO-4}, he was the one who introduced the ``illative
relation'' of implication into symbolic logic in the first place, by giving it a
distinguished symbol, as well as an extensive study of the algebraic laws
governing it (including Peirce's law).
...
\begin{remark}
  Seen as sequents, the nesting of flowers might be related to the nesting of judgments in the category of judgments used in the definition of some recent categorical semantics of type theory \cite{huang2023synthetic}.
\end{remark}
