...
Since every \kl{Proof} \kl{action} implements a $\Nature$-rule, it is guaranteed to be
\emph{\kl{invertible}}: the user never needs to \kl{Undo} a \kl{Proof} \kl{action} in order to
...
\kl{Import} \kl{actions} that may create unneeded copies of flowers\sidenote{In
this specific case, one might want to relax the atomic restriction on
\kl{Justify} \kl{actions}, in order to avoid the recourse to \kl{Undo}
\kl{actions}, which can only be performed at the top of the history stack.}.
...
Since every \kl{Edit} \kl{action} implements a $\Culture$-rule, it is guaranteed to be
\emph{non-\kl{invertible}}: the user might need to \kl{Undo} an \kl{Edit} \kl{action} in order to
