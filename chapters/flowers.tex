...
\reffig{eg-currying}. Yet we find that Peirce's insight on the topological
...
Spanish), that exists alongside the usual cuts (``\emph{cortes}''), and are
...
\begin{remark}
  ...
  the well-known Stone-Tarski interpretation of formulas as topological spaces
