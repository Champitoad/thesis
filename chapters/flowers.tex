...
We introduce the \emph{flower calculus}, a novel proof system for \kl{intuitionistic}
...
invertible proof system for \kl{intuitionistic} (predicate) logic that we know of is
...
definition of analyticity for \kl{deep inference} proof systems (especially the
