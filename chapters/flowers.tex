...
on some goals) nor complete. Then in \refsec{flowers-prover} we give an overview
...
\begin{figure*}
  \begin{mathpar}
    ...
    \xstep{\mathtt{RD}} &(\flower{a}{(\flower{}{(\flower{b}{b\sep})\sep})\sep})
    \\[1em]\hline\\
    ...
    \xstep{\mathtt{RD}} &(\flower{}{(\flower{a}{(\flower{}{b\sep a\sep})\sep}), (\flower{b}{(\flower{}{b\sep a\sep})\sep})\sep})
    \\[1em]\hline\\
...
course in Edukera \cite{edukera} (see \reffig{app:flowers-edukera}). Since those
are expressed with symbolic formulas, we rely on a straightforward translation
of formulas into flowers, following the interpretation of \reffig{curl-geom}.
