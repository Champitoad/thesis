...
\begin{proof}
  ...
  and $\inv{\Xi^+\select{\Xi'\hole}} = \inv{\Xi^+\hole} +
  \inv{\Xi'\hole}$ is even since it is the sum of two even numbers; or
  $\Xi'\hole$ is negative, and $\inv{\Xi^+\select{\Xi'\hole}}$ is odd since
