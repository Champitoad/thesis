...
correspond to Peirce's usage of the \kl{illative transformations} --- and thus to
...
Note that the scope of a \kl{binder} located in a pistil extends both to the pistil
\emph{and} to all its attached petals, whereas for a \kl{binder} located in a petal
...
not coincide with its \kl{depth}, since petals increase \kl{depth} but preserve \kl{polarity}:
...
\kl{binders} by \kl{LoIs} (\kl{lines of identity}, see \refsec{beta}), then the pollination
relation would also prescribe in which areas \kl{LoIs} can be extended/iterated,
providing an explanation for the scope of \kl{binders} (\refremark{flower-scope}).
...
\begin{description}
  ...
  \item[Unification (\kl{ipis}, \kl{ipet}, \kl{apis}, \kl{apet})]
    ...
    surprising since in the \kl{LoI} syntax of \kl{EGs}, they are special cases of
...
with any number of petals, flowers and \kl{binders}. In particular, this means that
...
\kl{lines of identity} of \kl{EGs} in a \emph{global} rather than local way. In particular,
