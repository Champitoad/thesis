...
Kay in its Smalltalk system \sidecite[4em]{goldberg_smalltalk-72_1976}.
\end{remark}
...
setting, any proof in the Flower Prover would be reduced to a sequence of
...
in the shelf:
\begin{itemize}
  \item[\textbf{Pollination}] the user can perform an \action{Import} action by
  dragging $\phi$;
  \item[\textbf{Jump to definition}] the user can focus on the subgoal where
  $\phi$ originates by clicking on $\phi$.
\end{itemize}
