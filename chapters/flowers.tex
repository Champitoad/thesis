...
binders by \kl{LoI} (\kl{lines of identity}, see \refsec{beta}), then the pollination
relation would also prescribe in which areas \kl{LoI} can be extended/iterated,
