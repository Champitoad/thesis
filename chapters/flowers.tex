...
stemming from two fundamental \kl{icons}: the \kl{\kl{sheet of assertion}} ($\SA$),
...
\begin{description}
  ...
  \item[Disjunction/Absurdity Elimination (\rsf{srep})]
    ...
    Curry-Howard correspondence, it can be related to the \emph{pattern-matching
    generator} found in modern editors of some functional programming languages,
    such as the Hazel structure editor and the Agda \kl{proof assistant}
...
\begin{itemize}
  ...
  the interactive proof mode of modern \kl{proof assistants} like Coq, Lean and
...
In the so-called ``proof view'' or ``goal view'' of modern \kl{proof assistants} like
...
present themselves: \emph{natural language}. Indeed, \kl{symbolic} formulas reproduce
...
our drag-and-drop proof tactic (\refch{pba}), but also other \kl{symbolic}
...
definition of analyticity for \kl{deep inference} \kl{proof systems} (especially the
\kl{calculus of structures}), which at a glance seems to encompass our own
...
Flower Prover with \kl{proof assistants} based on the latter such as Coq, Lean and
...
calculus sketched above, where \kl{proof terms} can appear inside flowers.
