...
The chapter is organized as follows: in \refsec{\kl{IEGs}}, we retrace the origin of
Oostra's syntax for intuitionistic \kl{EGs} (hereafter ``\kl{IEGs}'') as a natural
generalization of the \emph{scroll}, an icon for implication introduced by
Peirce that inspired the very creation of \kl{EGs}. In \refsec{Flowers}, we explain
how flowers are really just a fun and metaphorical way to draw \kl{IEGs}, and proceed
...
% of C. S. Peirce \sidecite{Roberts+1973} (thereafter written ``\kl{EGs}'').
...
\section{Intuitionistic existential graphs}\labsec{\kl{IEGs}}
...
\begin{itemize}
  \item[\textbf{Generalization of \kl{EGs}}]
    As mentioned in \refsec{\kl{IEGs}}, the syntax of intuitionistic \kl{EGs} (and thus of
...
\refsec{\kl{IEGs}}): $\phi$ is true if the content $\Phi_i$ of one of its petals
...
generalization of coherent formulas at the end of \refsec{\kl{IEGs}}.
