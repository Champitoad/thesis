...
\begin{itemize}
  ...
  \item[\textbf{Cut-free completeness}]
    ...
    prove completeness of the analytic fragment of the \kl{proof system} with respect
    ...
    $\entails{\Nature} \phi$). And in the case of \kl{intuitionistic} logics, the
...
Weakening lemmas are also standard in \kl{proof theory} and type theory. Here they
...
This is exemplified in the Agda \kl{proof assistant}, where all manipulations are
...
instead of \kl{first-order logic}: this allows to store the partial proof terms
...
Agda. Existing explorations of the links between type theory and \kl{deep inference}
...
\begin{itemize}
  ...
  \item a type system for interaction nets based on a \kl{calculus of structures} for
