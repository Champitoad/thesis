...
intuitionistic \kl{EGs}. This allows us to prove admissibility theorems for many
...
Oostra's syntax for intuitionistic \kl{EGs} (hereafter ``\kl{IEGs}'') as a
...
This shows the classical view of Peirce on \kl{EGs}, who interprets the scroll as
...
still derive the currying and uncurrying laws in this intuitionistic setting,
...
intuitionistic setting by substituting the rule of \kl{Double-cut} with the rule
of Blank Antecedant.
\end{remark}
...
In \kl{Beta}, we would have exploited the classical equivalences $\neg \forall
...
one notable flaw, also shared with the classical \kl{cut}-based syntax: it quickly
...
As we did for classical \kl{EGs} in \refsec{multisets} and \refsec{gardens}, we are
...
flowers. This distinction does not exist in classical \kl{EGs}, because pistils and
...
\begin{description}
  \item[Blank Antecedant (\rsf{epis})]
    ...
    of the classical rule \rsf{Dcut{\ua}} of \kl{Alpha} and \sys{Beta}. The
...
\kl{B}, we gave a bi-intuitionistic (resp. classical) semantics to bubbles in
...
\begin{itemize}
  \item[\textbf{Generalization of \kl{EGs}}]
    As mentioned in \refsec{IEGs}, the syntax of intuitionistic \kl{EGs} (and thus of
    flowers) subsumes that of Peirce's classical \kl{EGs}, by seeing the \kl{cut} as a
...
of \emph{modus ponens} \kl{mp}, in sequent calculi the \kl(rule){cut} rule, and
in natural deduction the \emph{substitution theorem}.
...
cut-free sequent calculus given by Hermant in
...
\kl{BV} is the logic that motivated the whole development of the deep inference
...
\begin{itemize}
  ...
  \kl(rule){cut} rule in sequent calculus), we expose buttons in all the corresponding
...
\paragraph{Intuitionistic \kl{EGs}}
...
also mention that \kl{HS} could be turned into a deep inference calculus in the
...
sense coined by the deep inference community with systems like \kl{SKS} (see
...
intuitionistic logic, like the system \kl{ISp} of Tiu
