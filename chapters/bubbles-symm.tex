...
soundness, and during our literature review we found very few \kl{proof systems} for
...
nested sequent system, where like in \kl{BJ} \kl{inference rules} can be expressed
...
\begin{description}
  ...
  \item[Locality]
    ...
    an \kl{inference rule} to be \emph{local}. This terminology has been employed by
