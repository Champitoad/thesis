...
sequent calculus \kl{LJ} to the multi-conclusion calculus \sys{LK}. Like him,
...
for classical logic called ``\kl{system B}'', in reference to the symmetric
...
with respect to the cut-free nested sequent calculus \kl{DBiInt} of Postniece
...
of \emph{constant-domain} predicate logic (see
...
logic\sidenote{Other nested sequent systems for full intuitionistic logic exist
...
to rely in \refsec{bubbles-completeness} on the deep inference calculus
...
\begin{description}
  ...
  \item[Symmetry] 
    In classical logic, both sequent calculi like \kl{LK} and deep inference
    ...
    the asymmetry at work in the \kl{BJ} calculus, which looked quite
    ...
    coming from sequent calculus. Interestingly, the calculus \kl{ISgq} of Tiu
