...
literature, with topological intuitions of the bubble \kl{metaphor} shedding a new
...
\kl{right introduction rule} for $\lor$ is invertible.
...
\begin{description}
  ...
  \item[Symmetry] 
    ...
    through blue bubbles is also motivated by this quest for symmetry. It should
