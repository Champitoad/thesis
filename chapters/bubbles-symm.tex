...
able to abstract from the \kl[saturated]{saturation} status of \kl{solutions},
we reframe the syntax of \kl{solutions} with so-called \intro{branching
operators} $\J$:
\begin{align*}
...
of excluded middle}\sidenote{This was already noticed in
...
\begin{definition}[Symmetric interpretation]\labdef{sinterp}
  The \intro{symmetric interpretation} of a \kl{solution} is defined recursively by:
  \begin{align*}
    \sint{\Gamma \piq{\cS} \Delta} &=
