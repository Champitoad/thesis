...
\begin{marginfigure}
  ...
  \end{array}
  $$
  \caption{$\mathbb{H}$-rules for \kl{exclusion} $\lsub$}
...
\begin{description}
  ...
  \item[Linearity] 
    ...
    which for instance excludes the $\mathbb{I}$-rules of \kl{BJ} since they can
  ...
  \item[Symmetry] 
    ...
    resemble those of \kl{CoS} (e.g. with $\mathbb{I}$-rules), we do not aim for
    ...
    our $\mathbb{F}$-rules) \sidecite{tiu_local_2006}.
\end{description}
