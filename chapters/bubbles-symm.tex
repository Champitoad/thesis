...
\begin{description}
  ...
  \item[Locality]
    ...
    various authors in \kl{proof theory}, in ways that are often hard to compare. For
    ...
    rather than purely \kl{proof-theoretical} considerations. For instance, \kl{BJ}
...
this makes for a good \kl{proof-theoretical} foundation, around which variant calculi
