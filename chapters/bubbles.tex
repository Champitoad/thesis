...
of \emph{logical atomism} \cite[p.~11]{tractatus}\cite{klement_russells_2020}.
Even earlier in the history of logic, C. S. Peirce took inspiration from
chemical diagrams to devise his \emph{existential graphs} --- see
...
GUI presented in \refsec{flowers-prover}.
