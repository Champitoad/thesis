...
\todo{ Future work: explore the question of the logics associated to various
fragments of the $\mathbb{F}$-rules of system \sys{B}.}

\section{Conclusion and Perspectives}

\epigraph{ Reasoning is nothing but the discourse of the mind to its future
  self. }{\textbf{Charles Sanders Peirce}, 1903 \sidecite{peirce_ms_450}}
