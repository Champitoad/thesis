...
\begin{kaonote}
  ...
  \begin{description}
    \item[Locality] \sys{SKS} is the \emph{local} version of \sys{SKSg}, and
    thus we partake in a brief discussion on locality in \sys{SKS} and
    \sys{Alpha}, and what our simulation says about it;
    \item[Analyticity] crucially, our objective is to show at the end of this
    section that \sys{Alpha} is \emph{analytic}. Ma and Pietarinen very briefly
    discuss this question in their paper, by affirming that \sys{Alpha} is
