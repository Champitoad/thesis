...
\emph{tinctured} \kl{existential graphs} (Chapter 6 in \cite{Roberts+1973}).
...
unlike our graphical depiction of \emph{\kl{saturated}} \kl{solutions} in
\reffig{graphical-B}, or the color codes used for the various kinds of text
...
\end{fact}
\begin{proof}
  By a straightforward induction on $\gdepth{S\hole}$.
\end{proof}
