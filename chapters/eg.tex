...
\kl{EGs} through the lens of \emph{topology} and \emph{\kl{category theory}}; lastly,
...
\begin{remark}\labremark{eg-entitative}
  ...
  realizability constructions for linear logic in Girard's \kl{transcendental syntax}
...
\begin{description}
  ...
  \itemAP[\intro{Deiteration} \textit{(Factorization)}]
    ...
    outside of a \kl{cut} is very reminiscent of the \emph{outward} \kl{flow rules} of
...
ludics \cite{girard_locus_2001} and \kl{transcendental syntax}
...
\kl{hooks} with a so-called \intro{line of identity} (\intro{LoI}). In
...
interpretation of the syntax of \kl{Beta} in \kl{category theory}, the authors
...
pushing the idea further in his \kl{transcendental syntax} programme, by proposing to
