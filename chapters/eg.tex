...
so\sidenote{This is again reminiscent of Girard's metaphor, where the fact that
...
\sys{Beta} anymore. In pure first-order logic (i.e. in finite theories), because
of the \emph{subterm property}\todo{Find reference}, this should not break
analyticity: indeed we should only need \rsf{Deletion} on LoI, which connects
