...
C. S. Peirce is famous for his contributions to \kl{symbolic} logic, including among
...
even more \kl{iconic} notation, where negative areas are \emph{literally} drawn like
...
popularized by Gentzen with the \emph{subformula property} in \kl{sequent
...
positive answer to the question of analyticity in \kl{Alpha} at the end of
...
capture what is identified nowadays in \kl{symbolic} logic as \emph{purely
relational} \kl{first-order} theories (that is, without constant nor function
...
Now if one considers a \kl{first-order} theory with a predicate symbol $=$ satisfying
the usual \kl{axioms} for equality, then our sentence can alternatively be expressed
...
\begin{description}
  ...
  \begin{remark}\labremark{eg-forall-type-theory}
    ...
    \reffig{eg-forall-imp}. While the similarity also exists for the \kl{symbolic}
