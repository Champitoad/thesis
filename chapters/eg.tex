...
others his eponymous law for \kl{classical} logic, and his pioneering work on the
...
\kl[Hilbert system]{Hilbert} and \kl[Gentzen system]{Gentzen} proof systems, and
even \kl{deep inference} proof systems like the \kl{\kl{calculus of structures}}.
...
the diagrammatic syntax of the system \kl{Alpha} of \kl{EGs} for \kl{classical}
...
\kl{Alpha}, by simulating the \kl{calculus of structures} \intro{SKS} of Brünnler and
...
built, and can today be understood as a diagrammatic calculus for \kl{classical}
...
\begin{itemize}
  \item[\textbf{Insertion}]
    ...
    equivalent we found in the \kl{deep inference} literature is indeed the weakening
...
popularized by Gentzen with the \emph{subformula property} in \kl{sequent calculus}:
...
to simulate an existing proof system for \kl{classical} propositional logic, that is
...
As the name indicates, the objects manipulated by inference rules in \kl{calculi of
...
quantifiers 30 years before the standard Russell-Whitehead syntax for \kl{predicate
...
\begin{description}
  ...
  \begin{remark}\labremark{eg-forall-type-theory}
    ...
    manifestation of Peirce's pre-\kl{intuitionistic} conception of logic.
  \end{remark}
...
physical level of individuals (objects) enforced in the language of \kl{predicate
...
\begin{description}
  ...
  procedures implemented in automated and \kl{interactive theorem provers}; thus it
